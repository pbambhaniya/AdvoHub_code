...
public class SpinnerDaysAdapter extends BaseAdapter {
    ...
    public SpinnerDaysAdapter(Context context, ArrayList<SpinnerModel> objects) {
        super();
        this.c = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View row = inflater.inflate(R.layout.spinner_days_item, parent, false);
        TextView label = (TextView) row.findViewById(R.id.textDays);
